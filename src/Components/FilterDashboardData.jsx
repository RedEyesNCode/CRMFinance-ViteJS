...
const FilterDashboardData = () => {
  return (
    <main className=" w-full min-h-80 mt-5 px-10 py-8">
      <h2 className="bg-blue-500 text-white w-full rounded-md px-10 py-3 font-bold ">
        Today's Data
      </h2>
      <div className="flex w-full  mt-5 text-zinc-600 flex-wrap  gap-[183px] gap-y-12">
        <div className="users h-40 min-w-80 px-5 py-3 bg-[#E9E7F7] rounded-lg flex items-center gap-2">
          <div className="logo ">
            <svg
              className="shadow-lg shadow-[#8074fc80] bg-gradient-to-r from-[#3858f9] to-[#8e79fd] h-16 rounded-md p-2 fill-white"
              enable-background="new 0 0 469.682 469.682"
              version="1.1"
          ...
          <div className="data px-2 w-56 ">
            <h2 className="text-lg font-bold text-black">Users</h2>
            <p className="flex justify-between ">
              New <span>0</span>
            </p>
            <p className="flex justify-between ">
              Active Loan <span>0</span>
            </p>
            <p className="flex justify-between ">
              Inactive Loan <span>0</span>
            </p>
          </div>
        </div>
        <div className="Loans min-h-40 min-w-80 px-5 py-3 bg-[#E9E7F7] rounded-lg flex items-center justify-between">
          <div className="logo ">
            <svg
              className="shadow-lg shadow-[#fa6a8280] bg-gradient-to-r from-[#f53c5b] to-[#fb768c] h-16 rounded-md p-2 fill-white"
          ...
          <div className="data px-2 w-56">
            <h2 className="text-lg font-bold text-black">Loans</h2>
            <p className="flex justify-between ">
              Pending <span>0</span>
            </p>
            <p className="flex justify-between ">
        ...
        <div className="Packages min-h-40 min-w-80 px-5 py-3 bg-[#E9E7F7] rounded-lg flex items-center justify-between">
          <div className="logo">
            <svg
              className="shadow-lg shadow-[#0ba3604d] bg-gradient-to-r from-[#0ba360] to-[#3cba92] h-16 rounded-md p-2 fill-white"
          ...
          <div className="data px-2 w-56">
            <h2 className="text-lg font-bold text-black">Package</h2>
            <p className="flex justify-between ">
              Regular <span>0</span>
            </p>
            <p className="flex justify-between ">
        ...
        <div className="Kyc min-h-40 min-w-80 px-5 py-3 bg-[#E9E7F7] rounded-lg flex items-center justify-between">
          <div className="logo">
            <svg
              className="shadow-lg shadow-[#f19f5d80] bg-gradient-to-r from-[#ff5858] to-[#f09819] h-16 rounded-md p-2 fill-white"
          ...
          <div className="data px-2 w-56">
            <h2 className="text-lg font-bold text-black">KYC</h2>
            <p className="flex justify-between ">
              Pending <span>0</span>
            </p>
            <p className="flex justify-between ">
        ...
        <div className="EMI min-h-40 min-w-80 px-5 py-3 bg-[#E9E7F7] rounded-lg flex items-center justify-between">
          <div className="logo">
            <svg
              className="shadow-lg shadow-[#f19f5d80] bg-gradient-to-r from-[#ff5858] to-[#f09819] h-16 rounded-md p-2 fill-white"
              enable-background="new 0 0 512 512"
          ...
          <div className="data px-2 w-56">
            <h2 className="text-lg font-bold text-black">EMI</h2>
            <p className="flex justify-between ">
              Paid <span>0</span>
            </p>
            <p className="flex justify-between ">
...
export default FilterDashboardData;
