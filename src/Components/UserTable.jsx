  ...
  return (
    ...
    <div className="overflow-hidden  border border-gray-300 relative">
      ...
      {CurrentUser && isUserDetailsFrame && (
        <UserDetailsComponent user_data={CurrentUser} handleCloseUserDetails={handleCloseUserDetails}/>
      )}
    </div>
    {isUserDeleteFrame && (
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-sm">
        ...
        <div className="flex justify-end">
          <button onClick={() => handleHideUserDeleteFrame(CurrentUser)} className="px-4 py-2 bg-gray-200 text-gray-800 rounded-md mr-2">Cancel</button>
          <button onClick={() => deleteCurrentUser(CurrentUser)} className="px-4 py-2 bg-red-500 text-white rounded-md">Confirm</button>
        </div>
      </div>
    </div>
