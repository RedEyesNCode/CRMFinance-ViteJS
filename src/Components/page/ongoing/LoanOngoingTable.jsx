...
function LoanOngoingTable({ handle }) {
  ...
  if(leadsData==null){
    return (
          <h2 className="text-white text-[21px] font-semibold font-mono bg-orange-500 rounded-md p-2">No On-Going Loans Found !!</h2>
      )
  }
    ...
    <div className="overflow-hidden rounded-3xl border border-gray-300 relative">
      ...
      {!isLeadDetailFrame && (
        <div className="relative overflow-auto max-h-[680px] ">
                            <h2 className="m-[10px] text-[20px]  font-sans font-bold  text-white p-2 rounded-md border-amber-800 bg-amber-600">Pending for OnGoing Loans</h2>
                ...
                <tr key={index} className={`${index % 2 != 0 ? "bg-[#F4FAFF]" : ""}`}>
                   ...
                   <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex gap-2">
                    <button
                      ...
                      className="text-white bg-orange-500 px-3 py-2 rounded-sm font-mono border-4 border-black"
                    >
                      On going Loan Details
                    </button>
                    <button
