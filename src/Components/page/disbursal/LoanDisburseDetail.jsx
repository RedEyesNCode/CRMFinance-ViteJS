...
function LoanDisburseDetail({ lead_data,handleCloseCallback }) {
  ...
  return (
    ...
    <div className='relative overflow-auto h-full'>
        <div className='flex flex-row items-center font-mono rounded-none bg-blue-400 border-2 border-blue-900  text-white'>
    ...
    <div className="flex">
      ...
      <div className="w-3/3 h-fit m-[10px] border-r pr-4 bg-slate-400 rounded-lg shadow-lg p-6 text-gray-700 text-[10px] ">
        ...
        <h2 className='font-semibold text-[18px] text-[#ffffff] bg-slate-500 rounded-lg p-6 m-[20px]'>Disbursal Loan KYC Documents</h2>
